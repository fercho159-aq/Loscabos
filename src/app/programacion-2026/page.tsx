...
export const metadata: Metadata = {
  ...
  description:
    "Sneak Peek de la programación 2026 de FICCLosCabos: el homenaje a Dolores Heredia, el Laboratorio de Escritura y el panel The Next Wave — Emerging Filmmaker Panel.",
