...
const groups: Group[] = [
  ...
  },
  {
    ...
    accent: "var(--color-orange)",
    people: [
      { name: "Carlos López Estrada", role: "Moderador <br> Cineasta y fundador de Antigravity Academy", image: "/images/programacion-2026/personas/carlos-lopez-estrada.jpg" },
      { name: "Mariana Mendívil", role: "“Memoria de un Cuerpo Desplazado” <br> Cineasta, artista visual y animadora", image: "/images/comunidad/mariana-mendivil.jpg" },
      { name: "Diego Gaxiola", role: "“Circo de Loy” <br> Guionista, director y productor", image: "/images/comunidad/diego-gaxiola.jpg" },
      { name: "Karla Condado", role: "“Miriam” <br> Directora, guionista y fotógrafa", image: "/images/comunidad/karla-condado.jpg" },
      { name: "Leo Aguirre", role: "“Isme” <br> Guionista y director", image: "/images/comunidad/leo-aguirre.jpg" },
      { name: "Amandine Thomas", role: "“Albatross” <br> Guionista, directora y editora", image: "/images/comunidad/amandine-thomas.jpg" },
      { name: "Federico Luis", role: "“For the opponents” <br> Guionista y director", image: "/images/comunidad/federico-luis.jpg" },
      { name: "Eduardo Braun Costa", role: "“Los Mentirosos” <br> Guionista, director y productor", image: "/images/comunidad/eduardo-braun-costa.jpg" },
      { name: "Gabriela Ortega", role: "“Marga en el DF” <br> Directora, guionista y actriz", image: "/images/comunidad/gabriela-ortega.jpg" },
      { name: "Martín André", role: "“La pena no duerme de noche” <br> Cineasta y animador", image: "/images/programacion-2026/personas/martin-andre.jpg" },
      { name: "Josefina Montino", role: "“La pena no duerme de noche” <br> Cineasta y periodista", image: "/images/programacion-2026/personas/josefina-montino.jpg" },
      { name: "Natalia León", role: "“Como si la tierra se las hubiera tragado” <br> Guionista, directora, animadora y actriz", image: "/images/comunidad/natalia-leon.jpg" },
    ],
  },
  {
    id: "voces-ficc",
