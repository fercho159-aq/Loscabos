...
const groups: Group[] = [
  ...
  },
  {
    ...
    people: [
      ...
      { name: "Álvaro Martínez", role: "Director y productor", image: "/images/comunidad/alvaro-martinez.jpg" },
      { name: "Pablo Díaz de León Hicks", role: "Artista CG, animador y director", image: "/images/comunidad/pablo-diaz-de-leon-hicks.jpg" },
      { name: "Eliseo Hagerman", role: "Productor musical y compositor", image: "/images/comunidad/eliseo-hagerman.jpg" },
