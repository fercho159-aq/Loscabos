...
const perfiles = [
  { title: "Africa Express (2025)", director: "Emilio Guerrero", desc: "El registro de la colisi\u00f3n entre Damon Albarn (Blur/Gorillaz) y M\u00e9xico. Un puente entre el britpop y los ritmos africanos en suelo azteca.", tag: "Selecci\u00f3n Oficial" },
  { title: "El sinaloense (2025)", director: "Luis Kles", desc: "M\u00e1s all\u00e1 del folclore, una exploraci\u00f3n de la identidad y el mito. Una b\u00fasqueda por desmitificar el estigma para encontrar la esencia del norte.", tag: "Selecci\u00f3n Oficial" },
  { title: "Casa de guerreras (2025)", director: "Alejandro Paredes", desc: "Un retrato de resiliencia femenina. Se aleja del drama convencional para enfocarse en la fuerza colectiva y el legado de lucha.", tag: "Selecci\u00f3n Oficial" },
  { title: "Al interior del fuego (2025)", director: "TaGolfo de California a Acu\u00f1a", desc: "Cine de sensaciones. La dualidad entre destrucci\u00f3n y creaci\u00f3n, usando el fuego como met\u00e1fora visual de la transformaci\u00f3n personal.", tag: "Selecci\u00f3n Oficial" },
  { title: "Un lugar para volver (2025)", director: "Amanda P\u00e9rez Contreras", desc: "Una b\u00fasqueda sobre el desarraigo y el paisaje irreconocible al volver a casa. Un tema universal tratado con una est\u00e9tica muy personal.", tag: "Selecci\u00f3n Oficial" },
  ...
  { title: "Tempestad (2015)", director: "Tatiana Huezo", desc: "Impulsada en etapa de Work in Progress. Menci\u00f3n Especial en la Berlinale y ganadora de 3 Premios Ariel.", tag: "Work in Progress" },
];
