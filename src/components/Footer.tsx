  ...
  return (
    <footer className="site-footer">
      ...
      <div className="footer-social-bar">
        <a href="https://www.instagram.com/loscabosiff" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
        ...
        <a href="https://www.facebook.com/share/1P9cUtE3Yt/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://youtube.com/@loscabosiff" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://www.linkedin.com/company/loscabosiff" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
