  ...
  return (
    <section ref={sectionRef} className="bg-[#0A1E23] md:h-screen md:overflow-hidden">
      <div className="flex flex-col md:h-full">
        ...
        <div ref={row1Ref} className="flex flex-col md:flex-row flex-none h-auto md:h-[34vh] overflow-hidden">
          ...
          <div className="relative w-full md:w-1/2 h-[45vw] md:h-full overflow-hidden flex items-end pb-6 px-5 md:pb-10 md:px-14">
            ...
            <img
              ref={bgSvgRef}
              src="/images/el-festival/PlataformasImpulsoIndustria.svg"
              alt=""
              aria-hidden="true"
            ...
            <h2 className="relative z-10 text-navy font-black text-[clamp(1.75rem,6vw,64px)] leading-[1.05] tracking-[-0.015em]">
              {["Plataformas de", "Impulso a la", "Industria del Cine"].map((line, li) => {
        ...
        <div ref={row2Ref} className="flex flex-col md:flex-row bg-[#0A1E23] md:flex-1 md:min-h-0">
          ...
          <div className="w-full md:w-1/3 h-auto md:h-full flex items-start justify-start p-5 md:p-10">
            ...
            <img
              ref={iconRef}
              src="/images/el-festival/icon 3.svg"
              alt=""
              aria-hidden="true"
