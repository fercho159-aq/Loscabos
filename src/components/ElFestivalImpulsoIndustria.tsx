...
export default function ElFestivalImpulsoIndustria() {
      ...
      <div className="h-full flex flex-col">
        ...
        <div ref={row1Ref} className="flex flex-none h-[31vh] overflow-hidden will-change-transform">
          ...
          <div className="relative w-1/3 h-full overflow-hidden flex items-end pb-10 px-14">
            ...
            <img
              ref={bgSvgRef}
              src="/images/el-festival/Group 114.svg"
              alt=""
              aria-hidden="true"
            ...
            <h2 className="relative z-10 text-navy font-bold text-[88px] leading-[1.1] tracking-[-0.01em]">
              {["Impulso a", "la Industria"].map((line, li) => (
        ...
        <div ref={row2Ref} className="flex flex-1 bg-[#0A1E23] will-change-transform">
          ...
          <div className="w-1/2 h-full flex items-start justify-start p-10">
            ...
            <img
              ref={iconRef}
              src="/images/el-festival/Impulso a la Industria icon.svg"
              alt=""
              aria-hidden="true"
          ...
          <div className="w-1/2 h-full flex items-center py-8 pr-16 pl-4">
            <div ref={textRef} className="text-cream font-medium text-[32px] leading-snug tracking-normal w-[600px] text-justify">
              <p>
                {"Nuestras plataformas reducen la brecha entre creación, industria y audiencias. A través de La Baja Inspira, el Fondo Gabriel Figueroa y Frequencies of Now, actuamos como un motor de formación, financiamiento y exhibición.".split(" ").map((word, i) => (
                  <span key={i} className="body-word">{word}{" "}</span>
                ))}
                <br />
                {"Diseñadas para generar convergencia, estas plataformas fortalecen trayectorias creativas y construyen puentes reales entre el talento mexicano y el mercado internacional.".split(" ").map((word, i) => (
