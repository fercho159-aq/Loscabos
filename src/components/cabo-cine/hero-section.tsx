  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center text-center text-white overflow-hidden">
      ...
      <div className="relative z-10 p-4 animate-in fade-in duration-1000 flex flex-col items-center">
        ...
        <p className="mt-4 font-headline text-sm text-background tracking-widest">
            #BEYONDTHESCREEN
        </p>
        ...
        <div className="mt-12">
            ...
            <Button asChild size="lg" className="font-headline text-lg py-3 px-8 group transition-all duration-300 transform hover:scale-105 bg-accent text-accent-foreground hover:bg-accent/90">
