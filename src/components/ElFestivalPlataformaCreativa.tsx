  ...
  return (
    <section ref={sectionRef} className="min-h-screen md:h-screen overflow-visible md:overflow-hidden bg-[#0A1E23]">
      <div className="h-full flex flex-col">
        ...
        <div ref={row1Ref} className="flex flex-col md:flex-row flex-none h-auto md:h-[25vh] overflow-hidden will-change-transform">
          ...
          <div className="relative w-full md:w-1/2 h-[45vw] md:h-full overflow-hidden flex items-end pb-6 px-5 md:pb-10 md:px-14">
            ...
            />
            <h2 className="relative z-10 text-navy font-bold text-[clamp(2rem,8vw,80px)] leading-[1.1] tracking-[-0.01em]">
