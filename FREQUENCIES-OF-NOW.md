...
- `OPEN_AT` 2026-09-24 00:00 (UTC-7), `CLOSE_AT` 2026-10-30 23:59.
- `FORM_URL = null` -> boton "Aplica ahora" `disabled` con nota "Disponible a partir del 24 de septiembre de 2026". **Pegar el link del formulario ahi cuando exista** (lo gestiona Juan Patricio).
